#### Reglas del sistema de tiradas Multi
...
Multi se aprovecha de propiedades inherentes a la manera de elegir los dados y el cálculo de éxito para conseguir los objetivos anteriores con cálculo mental propio de educación primaria.
...
La única limitación para no usar dados de otros valores es únicamente física, pero no habría inconveniente en usar dados virtuales de cualquier valor para completar desafíos en este sistema.

Usaremos XdY para expresar X dados de Y caras. Ejemplo: 1d6: 1 dado de 6 caras.
...
No puede haber éxito si la dificultad supera el nivel en la habilidad o característica relevante.


##### Éxito automático

A partir de nivel 4, la tirada es al menos 1d4, y una tirada contra nivel 1 es un éxito automático. Es imposible no tener éxito en una tirada donde se pide 1 o más con un dado de cualquier valor. Para niveles 1, 2 o 3, el riesgo es obtener más de 1 pero más del nivel del jugador a la vez.

¿Un jugador de nivel 5 podría no tener éxito automático ya que la tirada con 1d6 tiene el riesgo de sacar un 6 y fallar?. La regla 1 impide que un nivel 5 no tenga éxito automático contra dificultad 1, ya que puede optar por jugar con nivel 4 y obtenerlo automáticamente.
...
A: Si, pero creo que es más fácil de asimilar en dos pasos.
